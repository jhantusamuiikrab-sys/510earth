    ...
    <>
      <section className="inner_page mrgn_tp inner_pad">
        <div className="container">
          ...
          <p>
           Buyers and sellers need a common platform to initiate home purchases and sales. 510earth.com is a fast-growing real estate brokerage company displaying the best properties in the megacity of Kolkata. As one of the prominent real estate services in India, our primary service comprises helping our clients with the complicated process of buying and selling properties.
          </p>
          ...
          <div className="row">
            <div className="offset-md-2 col-md-10">
              {services.map((item, index) => (
                <div
                  key={index}
                  className="service_top_inner hvr-sink"
                >
          ...
          <div className="row">
            <div className="col-md-6 d-flex">
              <div className="service_bottom_inner">
                ...
                <p>
                  We provide asset valuation services pertaining to land. It is a vital service where you can trust on our name and credibility. At 510earth, we offer valuations guided by Red Book valuation Standards. We offer our services locally on a one-off or recurring basis. We support our valuation services through strong research and the use of technology to make the process more efficient and ensure adherence to quality standards and timelines. We leverage our regional connectivity to produce accurate and timely cross-border valuations and advice upon request in special situations.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-6 d-flex">
              <div className="service_bottom_inner">
                ...
                <p>
                  We believe in building personal relationship especially when it comes to your home and financial securities related to it. We have been associated with fulfilling the homeownership dreams with our touch of security and protection. Our real estate practice covers various aspects of investment, commencing from conducting title due diligence of the target property. We regularly engage with clients in selling and purchasing an immovable property of all categories, from commercial to residential and agriculture. Furthermore, our team is competent in handling and counseling certain governmental and other compliances regarding the target property.
                </p>
              </div>
            </div>
          </div>
