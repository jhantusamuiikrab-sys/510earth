...
const StepOtherInformation = ({ formData, setFormData, onSubmit, onPrev }) => {
  ...
  // Extract selected category/sub-category (supports common data property paths)
  const selectedType = (
    formData?.subCategory ||
    formData?.propertyType ||
    formData?.initialDetails?.subCategory ||
    ""
  ).toLowerCase();

  const isFlatApartment = selectedType.includes("flat") || selectedType.includes("apartment");
  const isIndependentHouseVilla = selectedType.includes("house") || selectedType.includes("villa");
  const isCommercial = selectedType.includes("commercial") || (!isFlatApartment && !isIndependentHouseVilla);
    ...
    <div className="other_info_card">
      ...
      <div className="card_body" style={{ padding: "20px" }}>
        <form onSubmit={handleSubmit}>
          ...
          {/* Property Address (Visible for ALL types) */}
          ...
          {/* Property Age (Visible for Independent House/Villa and Commercial) */}
          {(isIndependentHouseVilla || isCommercial) && (
            <div className="form_group" style={{ marginBottom: "16px" }}>
          ...
          {/* Commercial Specific Fields (Visible ONLY for Commercial) */}
          {isCommercial && (
            <>
              {/* Number of Towers */}
              <div className="form_group" style={{ marginBottom: "16px" }}>
          ...
          {/* Ownership (Visible for ALL types) */}
