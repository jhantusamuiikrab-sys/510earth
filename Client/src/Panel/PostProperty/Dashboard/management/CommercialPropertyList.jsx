...
const MOCK_PROPERTIES = [
  {
    id: 1,
    image: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=150&auto=format&fit=crop&q=60',
    name: 'Abcd',
    city: 'Kolkata',
    status: 'Under Review'
  },
  {
    id: 2,
    image: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=150&auto=format&fit=crop&q=60',
...
const CommercialPropertyList = () => {
  ...
  const handleEditClick = (id) => {
    navigate(`/dashboard/edit-commercial-property/${id}`);
  };
