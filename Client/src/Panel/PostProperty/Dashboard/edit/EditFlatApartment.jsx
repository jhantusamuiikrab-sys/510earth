      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "20px", alignItems: "center" }}>
            <label>
              <input type="checkbox" name="open" /> Open Parking
            </label>
            <label>
              <input type="checkbox" name="covered" defaultChecked /> Covered
              Parking
            </label>
            <label>
              <input type="checkbox" name="mechanical" /> Mechanical Parking
            </label>
          </div>
        </div>
        ...
        <div style={{ marginLeft: "215px", marginBottom: "15px" }}>
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, coveredParkingCount: e.target.value })
            }
            style={{
              width: "200px",
              padding: "8px",
