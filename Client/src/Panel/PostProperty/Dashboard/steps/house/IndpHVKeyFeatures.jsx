...
const IndpHVKeyFeatures = () => {
  ...
  // Pre-fill state if context has previous keyFeatures data
  useEffect(() => {
    if (contextData?.keyFeatures) {
      setCaption(contextData.keyFeatures.caption || "");
      setPropertyOverview(contextData.keyFeatures.propertyOverview || "");
      setSelectedAmenities(contextData.keyFeatures.amenities || {});
    }
  }, [contextData]);
        ...
        <form onSubmit={handleNext}>
          ...
          <div style={styles.editorContainer}>
            ...
            <div style={styles.editorToolbar}>
              ...
              <button
                type="button"
                style={{ ...styles.toolBtn, textDecoration: "underline" }}
              >
                U
              </button>
              <button
                type="button"
                style={{ ...styles.toolBtn, textDecoration: "line-through" }}
              >
                S
              </button>
              <div style={styles.divider}></div>
            ...
            <div style={styles.editorFooter}>
              <span>P</span>
              <span>
                {propertyOverview.trim()
                  ? propertyOverview.trim().split(/\s+/).length
                  : 0}{" "}
                WORDS
              </span>
            </div>
