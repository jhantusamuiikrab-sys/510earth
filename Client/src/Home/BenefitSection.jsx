...
const BenefitSection = () => {
  ...
  const benefitsData = [
    {
      id: 1,
      icon: "/Front/NewHome/images/benefit_icon1.png",
    ...
    {
      id: 2,
      icon: "/Front/NewHome/images/benefit_icon2.png",
      title: "Protection",
    ...
    {
      id: 3,
      icon: "/Front/NewHome/images/benefit_icon3.png",
    ...
    {
      id: 4,
      icon: "/Front/NewHome/images/benefit_icon4.png",
      title: "Peace of Mind",
      ...
      <div className="container">
        ...
        <div className="row mb-4">
          <div className="col-md-12 text-center text-md-start">
            ...
            <p className="bene_para text-secondary lh-base" style={{ fontSize: '15.5px' }}>
        ...
        <div className="row g-4">
          {benefitsData.map((benefit) => (
            <div className="col-md-6 d-flex" key={benefit.id}>
              <div 
                className="benefit_box w-100 p-4 bg-white border rounded shadow-sm wow bounceIn"
                style={{ transition: 'transform 0.2s ease-in-out' }}
              >
                {/* Icon Wrapper */}
                <div className="mb-3 d-inline-block p-2 bg-light rounded">
                  <img 
                    src={benefit.icon} 
                    alt={benefit.title} 
                    className="img-fluid" 
                ...
                {/* Card Title */}
                <h4 className="h5 fw-bold text-dark mb-2">{benefit.title}</h4>
